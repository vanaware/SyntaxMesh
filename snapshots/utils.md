...
# Contexto Exportado do Projeto SyntaxMesh - Modo: UTILS

Gerado automaticamente em: 9/10/2026, 7:13:31 AM
...
export const DEBUG_CHANNEL_NAME = "syntaxmesh_debug_channel";
...
> O projeto é o **SyntaxMesh ${versaoDisplay}** estruturado em blocos. 
> Cada arquivo começa com um título indicando seu caminho relativo exato (ex: \`## Arquivo: src/main.ts\`).
> Sempre que sugerir alterações, indique claramente qual arquivo deve ser modificado com base nesses caminhos e forneça o novo código completo do arquivo.

---

# Contexto Exportado do Projeto SyntaxMesh ${versaoDisplay}- Modo: ${modo.toUpperCase()}
