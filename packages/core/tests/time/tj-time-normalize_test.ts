...
describe("TjTime.beginOfHour", () => {
  ...
  it("funciona para 23:59:59", () => {
    ...
    assertEquals(
      result.toSeconds(),
      TjTime.fromString("2026-01-15-23:00:00",).toSeconds(),
    );
  });
});
...
describe("TjTime.beginOfWeek", () => {
  ...
  it("domingo com startMonday=false retorna domingo atual", () => {
    ...
    assertEquals(
      result.toSeconds(),
      TjTime.fromString("2026-01-18-00:00:00",).toSeconds(),
    );
  });
  ...
  it("sábado com startMonday=false retorna domingo anterior", () => {
    ...
    assertEquals(
      result.toSeconds(),
      TjTime.fromString("2026-01-11-00:00:00",).toSeconds(),
    );
  });
});
...
describe("TjTime.beginOfQuarter", () => {
  ...
  it("abril (Q2) retorna abril", () => {
    ...
    assertEquals(
      result.toSeconds(),
      TjTime.fromString("2026-04-01-00:00:00",).toSeconds(),
    );
  });
  ...
  it("novembro (Q4) retorna outubro", () => {
    ...
    assertEquals(
      result.toSeconds(),
      TjTime.fromString("2026-10-01-00:00:00",).toSeconds(),
    );
  });
});
