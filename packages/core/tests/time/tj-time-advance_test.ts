...
describe("TjTime advances", () => {
  describe("hoursLater", () => {
    it("adds seconds correctly", () => {
      ...
      assertEquals(
        result.toSeconds(),
        TjTime.fromString("2026-01-01-13:00:00",).toSeconds(),
      );
    });
    ...
    it("adds multiple hours", () => {
      ...
      assertEquals(
        result.toSeconds(),
        TjTime.fromString("2026-01-01-17:00:00",).toSeconds(),
      );
    });
  });
  ...
  describe("sameTimeNextHour", () => {
    it("advances one hour", () => {
      ...
      assertEquals(
        result.toSeconds(),
        TjTime.fromString("2026-01-15-15:30:45",).toSeconds(),
      );
    });
    ...
    it("wraps to next day at midnight", () => {
      ...
      assertEquals(
        result.toSeconds(),
        TjTime.fromString("2026-01-16-00:30:45",).toSeconds(),
      );
    });
  });
  ...
  describe("sameTimeNextDay", () => {
    it("advances one day", () => {
      ...
      assertEquals(
        result.toSeconds(),
        TjTime.fromString("2026-01-16-14:30:45",).toSeconds(),
      );
    });
    ...
    it("handles month end overflow (jan 31 -> feb 1)", () => {
      ...
      assertEquals(
        result.toSeconds(),
        TjTime.fromString("2026-02-01-14:30:45",).toSeconds(),
      );
    });
    ...
    it("handles february non-leap year", () => {
      ...
      assertEquals(
        result.toSeconds(),
        TjTime.fromString("2026-03-01-14:30:45",).toSeconds(),
      );
    });
    ...
    it("handles february leap year", () => {
      ...
      assertEquals(
        result.toSeconds(),
        TjTime.fromString("2024-03-01-14:30:45",).toSeconds(),
      );
    });
    ...
    it("handles year end overflow (dec 31 -> jan 1)", () => {
      ...
      assertEquals(
        result.toSeconds(),
        TjTime.fromString("2027-01-01-14:30:45",).toSeconds(),
      );
    });
  });
  ...
  describe("sameTimeNextWeek", () => {
    it("advances one week with month overflow", () => {
      ...
      assertEquals(
        result.toSeconds(),
        TjTime.fromString("2026-02-04-14:30:45",).toSeconds(),
      );
    });
    ...
    it("crosses year boundary", () => {
      ...
      assertEquals(
        result.toSeconds(),
        TjTime.fromString("2027-01-06-14:30:45",).toSeconds(),
      );
    });
    ...
    it("stays within same month when no overflow", () => {
      ...
      assertEquals(
        result.toSeconds(),
        TjTime.fromString("2026-01-22-14:30:45",).toSeconds(),
      );
    });
    ...
    it("handles february leap year week", () => {
      ...
      assertEquals(
        result.toSeconds(),
        TjTime.fromString("2024-03-02-14:30:45",).toSeconds(),
      );
    });
  });
  ...
  describe("sameTimeNextMonth", () => {
    it("advances one month, keeps day when possible", () => {
      ...
      assertEquals(
        result.toSeconds(),
        TjTime.fromString("2026-02-15-14:30:45",).toSeconds(),
      );
    });
    ...
    it("handles day rollover when new month has fewer days", () => {
      ...
      assertEquals(
        result.toSeconds(),
        TjTime.fromString("2026-03-03-14:30:45",).toSeconds(),
      );
    });
    ...
    it("handles month end to year boundary", () => {
      ...
      assertEquals(
        result.toSeconds(),
        TjTime.fromString("2027-01-31-14:30:45",).toSeconds(),
      );
    });
    ...
    it("handles 31st of month to month with 30 days", () => {
      ...
      assertEquals(
        result.toSeconds(),
        TjTime.fromString("2026-07-01-14:30:45",).toSeconds(),
      );
    });
  });
  ...
  describe("sameTimeNextQuarter", () => {
    it("advances one quarter without clamp", () => {
      ...
      assertEquals(
        result.toSeconds(),
        TjTime.fromString("2026-04-15-14:30:45",).toSeconds(),
      );
    });
    ...
    it("wraps quarter at year boundary", () => {
      ...
      assertEquals(
        result.toSeconds(),
        TjTime.fromString("2027-01-15-14:30:45",).toSeconds(),
      );
    });
    ...
    it("handles 31st day rollover in quarter advance", () => {
      ...
      assertEquals(
        result.toSeconds(),
        TjTime.fromString("2026-05-01-14:30:45",).toSeconds(),
      );
    });
  });
  ...
  describe("sameTimeNextYear", () => {
    ...
    it("handles february 29 leap year rollover to non-leap", () => {
      ...
      assertEquals(
        result.toSeconds(),
        TjTime.fromString("2025-03-01-14:30:45",).toSeconds(),
      );
    });
    ...
    it("keeps same month and day when valid", () => {
      ...
      assertEquals(
        result.toSeconds(),
        TjTime.fromString("2027-06-15-14:30:45",).toSeconds(),
      );
    });
  });
  ...
  describe("nextDayOfWeek", () => {
    it("finds next monday", () => {
      ...
      assertEquals(
        result.toSeconds(),
        TjTime.fromString("2026-01-19-14:30:45",).toSeconds(),
      );
    });
    ...
    it("finds next tuesday from monday", () => {
      ...
      assertEquals(
        result.toSeconds(),
        TjTime.fromString("2026-01-13-14:30:45",).toSeconds(),
      );
    });
    ...
    it("finds next sunday from saturday", () => {
      ...
      assertEquals(
        result.toSeconds(),
        TjTime.fromString("2026-01-18-14:30:45",).toSeconds(),
      );
    });
    ...
    it("finds next wednesday from monday (2 days later)", () => {
      ...
      assertEquals(
        result.toSeconds(),
        TjTime.fromString("2026-01-14-14:30:45",).toSeconds(),
      );
    });
