...
- **Service Worker**: The app is an offline-capable Progressive Web App. Changes to caching logic should be made in `packages/service-worker/src/service-worker.ts`.
